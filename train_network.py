...
def train(args, tuning_mode=False):
    ...
    print(f"Length of val dataset: {len(val)}")
    print(f"Sum of train and val dataset: {len(train) + len(val)}")
    # 学習ステップ数を計算する
...
def prepare_subnetworks(args, cache_latents, accelerator, weight_dtype, vae, train_unet, train_text_encoder, unet, text_encoder, lr_scheduler, optimizer, train_dataloader, network, val_dataloader ):
    ...
    return text_encoder,unet,network,optimizer,train_dataloader,lr_scheduler,val_dataloader
